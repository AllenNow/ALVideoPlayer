...
#import "LKPortraitControlView.h"
@import Masonry;
#import "UIColor+Hex.h"
#import "LKVideoPlayerImage.h"

@interface LKPortraitControlView ()
/** 底部工具栏 */
...
@implementation LKPortraitControlView
...
- (UIButton *)playOrPauseBtn {
    if (!_playOrPauseBtn) {
        ...
        [_playOrPauseBtn setImage:[LKVideoPlayerImage imageNamed:@"play"] forState:UIControlStateNormal];
        [_playOrPauseBtn setImage:[LKVideoPlayerImage imageNamed:@"pause"] forState:UIControlStateSelected];
    }
...
- (UISlider *)videoSlider {
    if (!_videoSlider) {
        ...
        _videoSlider.tintColor = [UIColor colorWithHexString:@"3143ae"];
...
- (UIButton *)fullScreenBtn {
    if (!_fullScreenBtn) {
        ...
        [_fullScreenBtn setImage:[LKVideoPlayerImage imageNamed:@"full"] forState:UIControlStateNormal];
    }
