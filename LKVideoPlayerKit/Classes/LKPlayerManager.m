...
@implementation LKPlayerManager

+ (instancetype)playerManagerWithDelegate:(id<LKPlayerManagerDelegate>)delegate playerStatusModel:(LKPlayerStatusModel *)playerStatusModel {
    
    LKPlayerManager *playerMgr = [[LKPlayerManager alloc] init];
