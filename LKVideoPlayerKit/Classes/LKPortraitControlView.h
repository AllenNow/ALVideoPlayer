...
@protocol LKPortraitControlViewDelegate <NSObject>
...
@interface LKPortraitControlView : UIView
@property (nonatomic, weak) id<LKPortraitControlViewDelegate> delegate;
/** 重置ControlView */
