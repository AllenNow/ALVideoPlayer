...
//! Project version number for LKMaterialDesignSpinner.
FOUNDATION_EXPORT double LKMaterialDesignSpinnerVersionNumber;

//! Project version string for LKMaterialDesignSpinner.
FOUNDATION_EXPORT const unsigned char LKMaterialDesignSpinnerVersionString[];
 ...
 */
@interface LKMaterialDesignSpinner : UIView
