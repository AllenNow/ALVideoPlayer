...
@interface LKPlayerControlView : UIView
...
/** 竖屏控制层的View */
@property (nonatomic, strong) LKPortraitControlView *portraitControlView;
/** 横屏控制层的View */
@property (nonatomic, strong) LKLandScapeControlView *landScapeControlView;
/** 上次播放至xx秒(默认0) */
