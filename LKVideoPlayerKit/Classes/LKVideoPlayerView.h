...
@class LKPlayerStatusModel;

@protocol LKVideoPlayerViewDelagate <NSObject>
@optional
/** 双击事件 */
...
@interface LKVideoPlayerView : UIView
/** 视频控制层, 自定义层 */
@property (nonatomic, strong, readonly) LKPlayerControlView *playerControlView;
/** 未播放, 封面的View */
@property (nonatomic, strong) LKCoverControlView *coverControlView;
/** 未播放, loading时的View */
...
+ (instancetype)videoPlayerViewWithSuperView:(UIView *)superview
                                    delegate:(id<LKVideoPlayerViewDelagate>)delegate
                           playerStatusModel:(LKPlayerStatusModel *)playerStatusModel;
