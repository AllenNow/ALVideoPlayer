...
#import "LKPlayerManager.h"
#import "LKVideoPlayerView.h"
#import "LKPlayerStatusModel.h"
#import "LKBrightnessView.h"

@interface LKVideoPlayer ()<LKPlayerManagerDelegate, LKPlayerControlViewDelagate, LKPortraitControlViewDelegate, LKLandScapeControlViewDelegate, LKVideoPlayerViewDelagate, LKCoverControlViewDelegate>

// 代理
@property (nonatomic, weak) id<LKVideoPlayerDelegate> delegate;
// 最底层的父视图
@property (nonatomic, strong) LKVideoPlayerView *videoPlayerView;
// AVPlayer 管理
@property (nonatomic, strong) LKPlayerManager *playerMgr;
// 播放数据模型
...
@implementation LKVideoPlayer

#pragma mark - public method

+ (instancetype)videoPlayerWithView:(UIView *)view delegate:(id<LKVideoPlayerDelegate>)delegate playerModel:(LKPlayerModel *)playerModel {
    
    if (view == nil) {
        return nil;
    }
    
    LKVideoPlayer *instance = [[LKVideoPlayer alloc] init];
    instance.delegate = delegate;
    
    // 创建状态模型
    instance.playerStatusModel = [[LKPlayerStatusModel alloc] init];
    [instance.playerStatusModel playerResetStatusModel];
    
    // !!!: 最底层视图创建
    instance.videoPlayerView = [LKVideoPlayerView videoPlayerViewWithSuperView:view delegate:instance playerStatusModel:instance.playerStatusModel];
    ...
    // !!!: 创建AVPlayer管理
    instance.playerMgr = [LKPlayerManager playerManagerWithDelegate:instance playerStatusModel:instance.playerStatusModel];
...
- (void)setPlayerModel:(LKPlayerModel *)playerModel {
...
- (void)changePlayerState:(LKPlayerState)state {
    switch (state) {
        ...
        case LKPlayerStateFailed: {
            ...
            LKBrightnessViewShared.isStartPlay = YES;
...
- (void)didBuffer:(LKPlayerManager *)playerMgr { 
...
#pragma mark - LKPortraitControlViewDelegate
