...
@protocol LKLandScapeControlViewDelegate <NSObject>
...
@interface LKLandScapeControlView : UIView
@property (nonatomic, weak) id<LKLandScapeControlViewDelegate> delegate;
