#
# Be sure to run `pod lib lint LKVideoPlayerKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  spec.name             = 'LKVideoPlayerKit'
  spec.version          = '0.0.7'
  spec.summary          = 'A short description of LKVideoPlayerKit.'
...
TODO: Add long description of the pod here.
    ...
    spec.source_files = 'LKVideoPlayerKit/Classes/**/*.{h,m}'
    spec.public_header_files = 'LKVideoPlayerKit/Classes/*.h'
    spec.resource_bundles = {
        'LKVideoPlayerKit' => ['LKVideoPlayerKit/Assets/*.png']
       }
   ...
   spec.libraries     = 'sqlite3.0', 'bz2', 'z', 'c++', 'iconv.2.4.0'
    ...
    #spec.dependency 'LuckinIJKPlayer'
    spec.frameworks = 'AVKit'
    spec.dependency 'Masonry'
    spec.dependency 'SDWebImage'
    spec.vendored_frameworks = 'LKVideoPlayerKit/*.framework'
end
