...
@interface NEDADVideoBrightnessView ()
...
@implementation NEDADVideoBrightnessView

+ (instancetype)sharedBrightnessView {
    static NEDADVideoBrightnessView *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[NEDADVideoBrightnessView alloc] init];
...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.backImage = ({
            ...
            imgView.image        = [NEDADVideoPlayerImage imageNamed:@"ZFPlayer_brightness"];
